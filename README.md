...
<p align="center">I am jaconiasDev, e eu amo a tecnologia ❤️ <br><br> From Fromt-end development using node.js to frontend development using React/JavaScript, I am <strong>passionate to discover new stuffs</strong> and use them to create high quality solutions. Today, I'm a <strong>focused on web development.</p>&nbsp;
<!--
